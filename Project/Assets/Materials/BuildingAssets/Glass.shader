	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = saturate( ( tex2D( _AlphaMap, uv_AlphaMap ) * _AlphaStrength ) ).r;
