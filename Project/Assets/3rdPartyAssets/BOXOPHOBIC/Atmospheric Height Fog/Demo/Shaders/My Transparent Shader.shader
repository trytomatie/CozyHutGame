	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 temp_output_197_0_g1020 = ( ( WorldPosition2_g1020 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g1020 ) );
				float3 p1_g1028 = temp_output_197_0_g1020;
				float localSimpleNoise3D1_g1028 = SimpleNoise3D( p1_g1028 );
				...
				float lerpResult198_g1020 = lerp( 1.0 , saturate( ( ( localSimpleNoise3D1_g1028 - temp_output_7_0_g1026 ) / ( AHF_NoiseMax - temp_output_7_0_g1026 ) ) ) , ( NoiseDistanceMask7_g1020 * AHF_NoiseIntensity ));
...
/*ASEBEGIN
Version=19105
Node;AmplifyShaderEditor.Vector3Node;30;-1280,1664;Half;False;Property;_NoiseSpeed;Noise Speed;43;0;Create;True;0;0;0;False;0;False;0.5,0.5,0;0.5,0.5,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;32;-1280,1440;Half;False;Property;_NoiseScale;Noise Scale;42;0;Create;True;0;0;0;False;0;False;6;1.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;41;0,1024;Inherit;False;Property;_NoiseIntensity;Noise Intensity;41;0;Create;True;0;0;0;False;1;Space(10);False;0;0.103;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;0,1728;Inherit;False;Property;_VertexIntensity;Vertex Intensity;44;0;Create;True;0;0;0;False;0;False;0;0.103;0;0.2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;640,896;Inherit;False;Property;_Color;Color;40;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=F4799872F81B9547AB7474AFF040B5A749C4E784