	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_7_0_g1032 = AHF_FogDistanceStart;
				float temp_output_155_0_g1027 = saturate( ( ( distance( WorldPosition2_g1027 , _WorldSpaceCameraPos ) - temp_output_7_0_g1032 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1032 ) ) );
				...
				float lerpResult494_g1027 = lerp( 0.0 , frac( ( frac( dotResult16_g1034 ) * (Magic14_g1034).z ) ) , ( AHF_JitterIntensity * 0.1 ));
				...
				float temp_output_167_0_g1027 = saturate( ( ( ( break159_g1027.x + break159_g1027.y + break159_g1027.z ) - temp_output_7_0_g1029 ) / ( AHF_FogHeightStart - temp_output_7_0_g1029 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				...
				float3 p1_g1035 = temp_output_197_0_g1027;
				float localSimpleNoise3D1_g1035 = SimpleNoise3D( p1_g1035 );
				float temp_output_7_0_g1033 = AHF_NoiseMin;
				...
				float lerpResult198_g1027 = lerp( 1.0 , saturate( ( ( localSimpleNoise3D1_g1035 - temp_output_7_0_g1033 ) / ( AHF_NoiseMax - temp_output_7_0_g1033 ) ) ) , ( NoiseDistanceMask7_g1027 * AHF_NoiseIntensity ));
...
Node;AmplifyShaderEditor.FunctionNode;1028;-3328,-4608;Inherit;False;Base;0;;1027;13c50910e5b86de4097e1181ba121e0e;34,360,0,500,0,99,1,388,0,557,0,555,0,354,0,386,0,345,0,351,0,349,0,368,0,378,0,374,0,370,0,450,0,476,0,384,0,339,0,392,0,355,0,116,1,364,0,361,0,603,1,366,0,382,0,376,0,380,0,372,0,343,0,347,0,597,0,550,0;0;3;FLOAT4;113;FLOAT3;86;FLOAT;87
WireConnection;961;2;1028;86
WireConnection;961;3;1028;87
ASEEND*/
//CHKSM=ADDF07D3830EC759B7C211160BE4C729CCC81CEB